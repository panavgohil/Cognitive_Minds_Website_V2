      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} className="eyebrow mb-6 text-accent">About / 04</motion.p>
          ...
          <div className="lg:col-span-7 flex flex-col gap-10 lg:pt-16">
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ delay: 0.2 }} className="border-l-4 border-accent pl-6 text-3xl font-serif leading-snug text-paper md:text-4xl">We are the premier debating and public speaking society of Delhi Technological University.</motion.p>
